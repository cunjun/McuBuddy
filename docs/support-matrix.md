...
Machine-readable validation records live under `src/McuBuddy/validation/` and are exposed through
...
Record: `src/McuBuddy/validation/stm32l496vetx-pyocd-stlink.json`
...
Record: `src/McuBuddy/validation/stm32f103c8-jlink.json`
