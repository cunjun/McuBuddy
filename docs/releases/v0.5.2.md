...
This is the shipped v0.5.2 summary. See the [changelog](../../CHANGELOG.md) for chronological changes and the [Project Guide](../../PROJECT_GUIDE.md) for current guidance.
...
```powershell
python -m pytest
python -m ruff check src tests scripts skills\mcubuddy\scripts
